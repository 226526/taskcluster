begin
  ...
  lock table denylisted_notification;
  ...
  revoke select, insert, update, delete on denylisted_notification from $db_user_prefix$_notify;
  drop table denylisted_notification;
